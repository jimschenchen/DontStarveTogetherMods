...
return {
	...
	ANNOUNCE_COLD = "快變成雷檬冰了!",
	ANNOUNCE_HOT = "好熱...我的毛在燃燒!!",
	...
	ANNOUNCE_HOUNDS = "感覺有一群餓死狗在看著我?",
	ANNOUNCE_WORMS = "感覺那群餓死狗要出現了?",
	ANNOUNCE_HUNGRY = "誰來餵餵雷檬!",
	...
	ANNOUNCE_DAMP = "溼答答令我煩躁!!",
	ANNOUNCE_WET = "我想找個乾燥點的地方藏起來.",
	ANNOUNCE_WETTER = "到底哪來那麼多水?!",
	ANNOUNCE_SOAKED = "誰來救救雷檬 我快被水吃掉了!?",

	ANNOUNCE_BECOMEGHOST = "噗汪!!",
	ANNOUNCE_GHOSTDRAIN = "我感覺身體輕飄飄...",
	...
	BATTLECRY =
	{
		GENERIC = "不能讓你在我的視線內出現!!",
		PIG = "你這隻負心豬!!",
		PREY = "狩獵時間~!!",
		SPIDER = "互相傷害阿!",
		SPIDER_WARRIOR = "黃色比較強!",
		DEER = "是鹿角~!!",
		MOONPIG = "笨豬快醒醒!!",
	},
	COMBAT_QUIT =
	{
		...
		PREY = "食物跑了...",
		SPIDER = "你慢得像隻龜.",
		SPIDER_WARRIOR = "黃色好會跳!",
		MOONPIG = "這隻豬已經發瘋了!!",
	},
	DESCRIBE =
	{
		MULTIPLAYER_PORTAL = "是這個大眼仔把我帶來這裡的嗎?",
		ANTLION = 
		{
		...
		{
			HELD = "牠似乎在磨爪爪.",
			UNDERGROUND = "牠是不是想偷走地上的寶物",
			ABOVEGROUND = "這竹鼠被我發現了,不如...",
		},
		MOLEHILL = "不敢相信我居然無法徒手挖開它!",
		MOLEHAT = "牠眼睛看起來很小.",
        ...
        SPIDER_HIDER = "高額頭八角怪咖!",
        SPIDER_SPITTER = "長了八隻腳的怪咖!",
        SPIDERHOLE = "八角怪咖的窩.",
        SPIDERHOLE_ROCK = "八角怪咖的窩.",
        ...
        BEEQUEENHIVEGROWN = "這顆大黃球讓我感覺到危險?!",
		...
		BEEFALO =
		{
			FOLLOWER = "牠看起來跟同類一樣高興.",
			GENERIC = "是隻多毛的大傢伙!",
			NAKED = "毛剃光光 羞羞臉.",
			SLEEPING = "牠睡著看起來更大個.",
            --Domesticated states:
            DOMESTICATED = "這隻味道比較特別.",
            ORNERY = "牠看起來想把我當成吃的.",
            RIDER = "我想當野牛騎士.",
            PUDGY = "恩. 裝太多食物了.",
		},
        ...
        PIGHOUSE =
        {
            FULL = "我可以看到一個豬腦袋望向窗外.",
            GENERIC = "這房子豬豬居然擠的進去.",
            LIGHTSOUT = "我知道你這隻豬豬在家裡面開趴!",
            BURNT = "豬豬的家燒毀!",
        },
        PIGKING = "你溢出的肥油味讓我感到不悅!",
        PIGMAN =
        {
            DEAD = "也許該把它埋了.",
            FOLLOWER = "給你吃的快做事.",
        ...
        RESURRECTIONSTONE = "這一定是某隻老貓留下的磨爪板.",
        ROBIN =
        {
            GENERIC = "紅紅會飛的獵物?",
            HELD = "留著等等吃.",
        ...
        ROCK = "磨爪爪的好東西.",
        PETRIFIED_TREE = "它的毛可以磨爪爪.",
        ROCK_PETRIFIED_TREE = "它的毛可以磨爪爪.",
        ROCK_PETRIFIED_TREE_OLD = "它的毛可以磨爪爪.",
        ROCK_ICE =
        {
            GENERIC = "冰冰涼涼!",
            MELTED = "我想繞過這攤水.",
        },
        ROCK_ICE_MELTED = "我想繞過這攤水.",
        ICE = "冰冰涼涼!",
